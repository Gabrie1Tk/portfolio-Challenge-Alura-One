...
[![Ver Portfólio](https://img.shields.io/badge/Ver%20Portfólio-GitHub%20Pages-blue?style=for-the-badge&logo=github)](https://gabrie1tk.github.io/portfolio-Challenge-Alura-One/)
...
- [x] **Sobre Mim:** Apresentação pessoal e resumo da minha trajetória.
- [x] **Skills:** Lista de habilidades técnicas (Hard Skills) e comportamentais (Soft Skills).
- [x] **Formação:** Detalhes sobre cursos e graduações.
...
1.  **Clone o repositório:**
    ```bash
    git clone [https://github.com/Gabrie1Tk/portfolio-Challenge-Alura-One.git](https://github.com/Gabrie1Tk/portfolio-Challenge-Alura-One.git)
    ```
...
![Badge Oracle ONE](https://img.shields.io/badge/Oracle-ONE-orange?style=for-the-badge&logo=oracle)
